# Curso de introdução à Linguagem de programação Java:
...
- Guide to Java. A Concise Introduction to Programming - James, T. Streib and Takako Soma, Springer.

- Fundamental of Java Programming - Mitsunori Ogihara, Springer.

- Java Data Structure and Programming - Liwu Li, Springer.
...
Como a rotina de estudos estabelecida pelo Minsait é bem puxado, claro que não será possível conseguir praticar tudo! Eu irei deixar os exercícios para revisão! Ou seja, irei estuder bem os conceitos para quando for revisar, realizar os exercícios que não foram feitos.
